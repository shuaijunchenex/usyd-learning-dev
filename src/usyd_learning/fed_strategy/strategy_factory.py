    ...
    def create_runner_strategy(runner_strategy_args: StrategyArgs, client_nodes, server_node) -> ClientStrategy:
        ...
        match runner_strategy_args.strategy_name.lower():
            case "fedavg":
                ...
                return FedAvgRunnerStrategy._create_inner(runner_strategy_args, client_nodes, server_node)

        raise ValueError(f"Runner strategy type '{runner_strategy_args.strategy_name}' not support.")

    @staticmethod
    def create_client_strategy(client_strategy_args: StrategyArgs, client_node) -> ClientStrategy:
        """
        ...
        match client_strategy_args.strategy_name.lower():
            case "fedavg":
                ...
                return FedAvgClientTrainingStrategy._create_inner(client_strategy_args, client_node)

        raise ValueError(f"Client strategy type '{client_strategy_args.strategy_name}' not support.")

    @staticmethod
    def create_server_strategy(server_strategy_args: StrategyArgs, serve_node) -> ServerStrategy:
        """
        ...
        match server_strategy_args.strategy_name.lower():
            case "fedavg":
                ...
                return FedAvgServerStrategy._create_inner(server_strategy_args, serve_node)
