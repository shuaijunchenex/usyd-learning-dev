...
# NOT: After upload package to Nexus, comment path append
# sys.path.append("..")
# sys.path.append("../ml_simu_switcher")
# print("\n".join(sys.path))

from ml_simu_switcher.simu_switcher import SimuSwitcher, SimuNodeDataEventArgs
